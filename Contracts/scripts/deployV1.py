from brownie import network, config, ChainEstateTokenV1, ChainEstateAirDrop, ChainEstatePolling, MockWETH, PancakeRouter, PancakePair, PancakeFactory
...
def deploy_chain_estate_V1(realEstateWalletAddress=None, marketingWalletAddress=None, developerWalletAddress=None, liquidityWalletAddress=None, burnWalletAddress=None):
    ...
    chainEstateToken = ChainEstateTokenV1.deploy(
        INITIAL_SUPPLY,
